...
prod-indexnow: ## 🚀 Run IndexNow command in production (Examples: make prod-indexnow ARGS="blog_slug/post_slug", make prod-indexnow ARGS="--engine=yandex", make prod-indexnow ARGS="blog_slug --engine=bing")
