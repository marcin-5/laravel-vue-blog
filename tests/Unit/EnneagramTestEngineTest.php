...
test(
     ...
     */ 'creates a reproducible state from a seed', function () {
...
test(
    /**
     * @throws RandomException
     */ 'finishes stage two and returns the server-computed result', function () {
        $engine = new EnneagramTestEngine;
        $state = $engine->start(enneagramEngineData(), false, 12345, 'en');
        ...
        'config' => [
            'stages' => [
                'stage1' => [
                    ...
                    'part2' => ['maxQuestions' => 1, 'maxSkips' => 0, 'answersPerQuestion' => 1, 'minLead' => 1, 'minLeadAlternative' => 1],
                ],
                'stage2' => [
                    'part1' => ['maxQuestions' => 1, 'maxSkips' => 0, 'answersPerQuestion' => 1, 'minLead' => 1],
