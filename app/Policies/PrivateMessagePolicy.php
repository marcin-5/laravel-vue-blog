...
class PrivateMessagePolicy
{
    ...
    {
        return $privateMessage->conversation !== null
            && $privateMessage->conversation->participants()
     ...
     */
    public function create(User $user, PrivateConversation $privateConversation): bool
    {
