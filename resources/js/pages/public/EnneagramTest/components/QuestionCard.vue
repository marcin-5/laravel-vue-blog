...
<template>
    <Card class="w-full bg-card font-quicksand text-card-foreground">
        ...
        <CardContent class="px-2 md:px-3 lg:px-4">
            <div :aria-label="question.question" class="space-y-4 font-nunito md:space-y-3 lg:font-inter" role="group">
                <Button
                    ...
                    @click="toggle(option)"
                >
                    <span v-if="props.debugHints" class="my-auto mr-2 shrink-0 font-mono text-xs font-bold text-muted-foreground"
